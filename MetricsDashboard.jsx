/**
 * EvalForge AI — components/MetricsDashboard.jsx
 * Displays:
 *   - Live RLHF scoring weights vs defaults (weight drift)
 *   - Session score distribution
 *   - Feedback positive rate
 *   - Per-version prompt analytics
 *
 * Data is fetched from /feedback/stats and /history/metrics.
 */
...
import { getFeedbackStats, getMetrics } from "./frontend_api";
